...
const items = [
  {
    ...
    name: "Instagram",
    handle: "@team.apexgaming",
    followers: "Follow the org",
  ...
  },
  {
    icon: RiTwitterXLine,
    name: "Twitter / X",
    handle: "@Team_ApexGaming",
    followers: "Join the talk",
  ...
  return (
    <section className="container-apex py-20">
      <div className="text-center">
        ...
        <h2 className="mt-3 font-display font-semibold text-cream text-3xl md:text-4xl">
          Join the TAG community
        </h2>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="font-display font-semibold text-cream text-lg leading-tight truncate">
                  {it.handle}
                </p>
