...
export default function ComingSoon({
  ...
  return (
    <main className="relative min-h-[100svh] flex items-center justify-center bg-background overflow-hidden pt-20 pb-16">
      ...
      >
        <span
          className="font-display font-bold text-cream uppercase whitespace-nowrap"
          style={{
      ...
      <div className="container-apex relative z-10 text-center max-w-2xl">
        ...
        <div className="mt-12 max-w-md mx-auto">
          ...
          {sent ? (
            <p className="mt-4 text-sm text-success">
              ✓ You're on the list. Stay locked in.
            </p>
          ) : (
            <form
              onSubmit={(e) => {
        ...
        <Link
          href="/"
          className="mt-12 inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-cream transition-colors"
        >
