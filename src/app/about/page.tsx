  ...
  return (
    <>
      <PageHero
        eyebrow="Our Story"
        title="Our Story"
        subtitle="From a Goa gamer to one of India's most influential esports figures. This is how Team Apex Gaming was born."
      />
      ...
      <section className="container-apex py-12 grid gap-8 md:grid-cols-3 max-w-4xl mx-auto">
        <Para>
          <strong className="text-cream">The journey.</strong> Jonathan Jude
          Amaral grew up obsessed with mobile gaming. He built a community on
          YouTube, climbing to 7.7M+ subscribers - and turned a passion into a
          profession.
        </Para>
        <Para>
          <strong className="text-cream">The GodLike chapter.</strong> Joining
          GodLike Esports, Jonathan competed at the highest level of Indian
          BGMI, earned a Red Bull athlete deal, and became one of the country's
          most recognizable esports faces.
        </Para>
        <Para>
          <strong className="text-cream">The decision.</strong> In April 2026,
          he chose to leave GodLike and start fresh. Not as a player joining a
          team - as a founder building one. Team Apex Gaming was born.
        </Para>
      </section>
      ...
      <section className="container-apex py-20">
        <div className="card-apex p-8 md:p-10">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="h-32 w-32 shrink-0 rounded-full border-2 border-primary bg-surface-2 flex items-center justify-center overflow-hidden">
              {j.avatar ? (
                <Image
                  src={j.avatar}
                  alt={j.alias}
            ...
            <div className="flex-1">
              ...
              <h3 className="mt-3 font-display font-bold text-cream text-3xl md:text-4xl">
                {j.alias}
              </h3>
              ...
              <div className="mt-5 flex flex-wrap gap-1.5">
                {j.badges.map((b) => (
                  <span key={b} className="pill-muted">
                    {b}
                  </span>
                ))}
              </div>
              {j.stats && (
                <div className="mt-5 grid grid-cols-3 gap-3 max-w-md">
                  {j.stats.map((s) => (
                    <div
                      key={s.label}
                      className="rounded-md bg-surface-2 px-3 py-3 text-center"
                    >
              ...
              <div className="mt-5 flex items-center gap-3">
                {j.instagram && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-muted-strong hover:text-primary"
                  >
