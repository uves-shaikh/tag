  ...
  return (
    <>
      <PageHero
        ...
        title="The Apex Family"
        subtitle="Three pillars. One vision."
      />
          ...
          return (
            ...
            >
              <div className="md:col-span-2 flex flex-col items-center text-center">
                <div className="h-32 w-32 rounded-full border-2 border-primary bg-surface-2 flex items-center justify-center overflow-hidden">
                  {m.avatar ? (
                    <Image
                      src={m.avatar}
                      alt={m.alias}
                ...
                <h2 className="mt-4 font-display font-bold text-cream text-3xl">
                  {m.alias}
                </h2>
